    ...
    return (
        <nav className="sticky top-0  md:top-10 z-40 md:py-3 max-w-landing-width mx-auto w-full flex justify-between items-center md:rounded-xl border-b md:border border-[rgba(0,0,0,0.2)] xl:p-8 p-2 pl-4 backdrop-blur-md bg-white/80">
            ...
            <ul className="hidden w-2/3 xl:flex flex-row items-center justify-between">
                ...
                <li>+237 696 80 60 11</li>
            </ul>
            <ul className="flex w-1/3 xl:hidden justify-end">
                <Dialog>
                <DialogTrigger>
                    <div className="p-3.5 pr-5 pl-5 bg-black text-white rounded-xl">contact</div>
                </DialogTrigger>
                <DialogContent>
                    <DialogHeader>
                    <DialogTitle>Contact</DialogTitle>
                    <DialogDescription>
                        Toute les methodes pour me contacter
                    </DialogDescription>
                    </DialogHeader>
                    <div className="w-full p-3 5">
                        <a href="mailto:othchristian@icloud.com" className="flex gap-3 items-center mt-3.5 border border-blue-500 p-3.5 rounded-xl bg-blue-100 xl:bg-gray-50 hover:bg-blue-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="oklch(62.3% 0.214 259.815)" className="bi bi-envelope-at" viewBox="0 0 16 16">
                            ...
                            <p>contact via mail</p>
                        </a>
                        <a href="https://wa.me/237696836011" className="flex gap-3 items-center mt-3.5 border border-green-500 p-3.5 rounded-xl bg-green-100 xl:bg-gray-50 hover:bg-green-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="oklch(72.3% 0.219 149.579)" className="bi bi-whatsapp" viewBox="0 0 16 16">
