            ...
            <ul className="flex w-1/3 xl:hidden justify-end">
                ...
                <DialogContent>
                    ...
                    <div className="w-full p-3 5">
                        <a href="mailto:othchristian@icloud.com" className="flex gap-3 items-center mt-3.5 border border-blue-500 p-3.5 rounded-xl bg-gray-50 hover:bg-blue-100">
                        ...
                        <a href="https://wa.me/237696836011" className="flex gap-3 items-center mt-3.5 border border-green-500 p-3.5 rounded-xl bg-gray-50 hover:bg-green-100">
                            ...
                            <p>envoyez moi message sur whatsapp</p>
                        </a>
                    </div>
                </DialogContent>
                </Dialog>
